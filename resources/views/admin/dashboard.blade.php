    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="utf_dashboard_list_box with-icons margin-top-20">
                ...
                <ul>
                    <li>
                        <i class="utf_list_box_icon sl sl-icon-layers"></i> Peter Parker Left A Review 5.0 On
                        <strong><a href="#"> Restaurant</a></strong> <a href="#" class="close-list-item"><i
                    ...
                    <li>
                        <i class="utf_list_box_icon sl sl-icon-star"></i> Someone Bookmarked Your <strong><a
                                href="#">Listing</a></strong> Restaurant <a href="#" class="close-list-item"><i
                                class="fa fa-close"></i></a>
                    </li>
                    <li>
            ...
            <div class="utf_dashboard_list_box invoices with-icons margin-top-20">
                ...
                <ul>
                    <li><i class="utf_list_box_icon sl sl-icon-doc"></i> <strong>Premium Plan <span
                        ...
                        <div class="buttons-to-right"> <a href="{{ url('/admin/invoice') }}" class="button gray"><i
                ...
                <div class="dashboard-list-box table-responsive invoices with-icons">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('public/admin/images/thumb-1.jpg')}}"
                                        width="50" height="50"></td>
                                <td>Kathy Brown</td>
                                <td>12 Jan 2022</td>
                                <td>Paypal</td>
                                <td><span class="badge badge-pill badge-primary text-uppercase">Booked</span></td>
                                <td><a href="dashboard_bookings.html" class="button gray"><i class="fa fa-eye"></i>
                                        View</a></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('public/admin/images/thumb-2.jpg')}}"
                                        width="50" height="50"></td>
                                <td>Kathy Brown</td>
                                <td>12 Jan 2022</td>
                                <td>Credit Card</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><img alt="" class="img-fluid rounded-circle shadow-lg" src="{{asset('public/admin/images/thumb-3.jpg')}}"
                                        width="50" height="50"></td>
                                <td>Kathy Brown</td>
                                <td>12 Jan 2022</td>
                                <td>Paypal</td>
