                ...
                <ul>
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-01.jpg')}}" alt=""></a>
                            </div>
                    ...
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-02.jpg')}}" alt=""></a>
                            </div>
                            <div class="utf_list_box_listing_item_content">
                                <div class="inner">
                    ...
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-03.jpg')}}" alt=""></a>
                            </div>
                            <div class="utf_list_box_listing_item_content">
                                <div class="inner">
                    ...
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-04.jpg')}}" alt=""></a>
                            </div>
                            <div class="utf_list_box_listing_item_content">
                                <div class="inner">
                    ...
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-05.jpg')}}" alt=""></a>
                            </div>
                            <div class="utf_list_box_listing_item_content">
                                <div class="inner">
                    ...
                    <li>
                        <div class="utf_list_box_listing_item">
                            <div class="utf_list_box_listing_item-img"><a href="#"><img
                                        src="{{asset('public/admin/images/utf_listing_item-06.jpg')}}" alt=""></a>
                            </div>
                            <div class="utf_list_box_listing_item_content">
                                <div class="inner">
