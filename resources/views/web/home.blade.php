<div class="search_container_block overlay_dark_part">
    ...
    <div class="utf_video_container">
      <video poster="{{asset('public/web/images/search_video_bg.jpg')}}" loop autoplay muted>
        <source src="{{asset('public/web/images/search_bg_video.mp4')}}" type="video/mp4">
      </video>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="container_categories_box margin-top-5 margin-bottom-30"> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Hotel"></i>
			<h4>Hotels</h4>
			<span>22</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Hamburger"></i>
			<h4>Eat & Drink</h4>
			<span>15</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Shop-2"></i>
			<h4>Shops</h4>
			<span>05</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Cocktail"></i>
			<h4>Nightlife</h4>
			<span>12</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Electric-Guitar"></i>
			<h4>Events</h4>
			<span>08</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Dumbbell"></i>
			<h4>Fitness</h4>
			<span>18</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Home-2"></i>
			<h4>Real Estate</h4>
			<span>14</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Chef-Hat"></i>
			<h4>Restaurant</h4>
			<span>22</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Couple-Sign"></i>
			<h4>Dance Floor</h4>
			<span>20</span>
          </a> 
          <a href="{{ url('/listing') }}" class="utf_category_small_box_part"> <i class="im im-icon-Old-Cassette"></i>
			<h4>Cinema</h4>
			<span>07</span>
          </a> 
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="simple_slick_carousel_block utf_dots_nav"> 
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-01.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Chef-Hat"></i> Restaurant</span> <span class="featured_tag">Featured</span>
				  ...
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-02.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Electric-Guitar"></i> Events</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">							
				  ...
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-03.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
				  ...
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-04.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Dumbbell"></i> Fitness</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">							
							<span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $45 - $70</span>							
							<span class="utp_approve_item"><i class="utf_approve_listing"></i></span>
				  ...
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-05.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span> <span class="featured_tag">Featured</span>
					  <span class="utf_closed">Closed</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">							
							<span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $45 - $70</span>							
				  ...
				  <div class="utf_carousel_item"> <a href="{{ url('/listing') }}" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-06.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Chef-Hat"></i> Restaurant</span>
					  <span class="utf_open_now">Open Now</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">							
  ...
  <a href="listings_grid_full_width.html" class="flip-banner parallax" data-background="{{asset('public/web/images/slider-bg-02.jpg')}}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666">
    ...
    <div class="fullwidth_carousel_container_block margin-top-20">
      <div class="utf_testimonial_carousel testimonials"> 
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('public/web/images/happy-client-01.jpg')}}" alt="">
        ...
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('public/web/images/happy-client-02.jpg')}}" alt="">
        ...
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('public/web/images/happy-client-03.jpg')}}" alt="">
  ...
  <div class="container padding-bottom-70">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-01.jpg')}}">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-02.jpg')}}">
			<div class="utf_img_content_box visible">
			  <h4>Shops</h4>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-03.jpg')}}">
			<div class="utf_img_content_box visible">
			  <h4>Restaurant</h4>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-04.jpg')}}">
			<div class="utf_img_content_box visible">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-05.jpg')}}">
			<div class="utf_img_content_box visible">
			  <h4>Hotels</h4>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12"> 
         <a href="{{ url('/listing') }}" class="img-box" data-background-image="{{asset('public/web/images/popular-location-06.jpg')}}">
			<div class="utf_img_content_box visible">
			  <h4>New York</h4>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="companie-logo-slick-carousel utf_dots_nav">
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_01.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_02.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_03.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_04.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_05.png')}}" alt="">
					</div>		
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_06.png')}}" alt="">
					</div>	
					<div class="item">
						<img src="{{asset('public/web/images/brand_logo_07.png')}}" alt="">
					</div>					
				</div>
			</div>
		</div>
