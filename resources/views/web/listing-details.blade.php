        <div id="utf_listing_gallery_part" class="utf_listing_section">
            <div class="utf_listing_slider utf_gallery_container margin-bottom-0">
                <a href="{{asset('public/web/images/single-listing-01.jpg')}}" data-background-image="{{asset('public/web/images/single-listing-01.jpg')}}"
                    class="item utf_gallery"></a>
                <a href="{{asset('public/web/images/single-listing-02.jpg')}}" data-background-image="{{asset('public/web/images/single-listing-02.jpg')}}"
                    class="item utf_gallery"></a>
                <a href="{{asset('public/web/images/single-listing-03.jpg')}}" data-background-image="{{asset('public/web/images/single-listing-03.jpg')}}"
                    class="item utf_gallery"></a>
                <a href="{{asset('public/web/images/single-listing-04.jpg')}}" data-background-image="{{asset('public/web/images/single-listing-04.jpg')}}"
                    class="item utf_gallery"></a>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-8">
                    <div id="titlebar" class="utf_listing_titlebar">
                        <div class="utf_listing_titlebar_title">
                            ...
                            <span> <a href="#utf_listing_location" class="listing-address"> <i
                                        class="sl sl-icon-location"></i> The Ritz-Carlton, Hong Kong </a> </span>
                        ...
                        <div class="show-more">
                            <div class="utf_pricing_list_section">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <h5>French Crostini <sub class="ppl-offer label-light-success">10% Off</sub>
                                        </h5>
                                        <p>Breakfast Sandwich on a Roll with 2 Eggs</p>
                                        <span>$130</span>
                                    </li>
                                    <li>
                                        <h5>Caramelised Rum Punch <sub class="ppl-offer label-light-success">15%
                                                Off</sub></h5>
                    ...
                    <div id="utf_listing_reviews" class="utf_listing_section">
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-2 review_progres_title">
                                            <small><strong>Quality</strong></small></div>
                                        <div class="col-lg-9">
                                            <div class="progress">
                                        ...
                                        <div class="col-lg-1 review_progres_title"><small><strong>77</strong></small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 review_progres_title"><small><strong>15</strong></small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 review_progres_title"><small><strong>18</strong></small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-2 review_progres_title">
                                            <small><strong>Service</strong></small></div>
                                        <div class="col-lg-9">
                                            <div class="progress">
                                        ...
                                        <div class="col-lg-1 review_progres_title"><small><strong>10</strong></small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-2 review_progres_title">
                                            <small><strong>Location</strong></small></div>
                                        <div class="col-lg-9">
                                            <div class="progress">
                                        ...
                                        <div class="col-lg-1 review_progres_title"><small><strong>05</strong></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="comments utf_listing_reviews">
                            <ul>
                                <li>
                                    <div class="avatar"><img src="{{asset('public/web/images/happy-client-01.jpg')}}" alt="" /></div>
                                    <div class="utf_comment_content">
                                        <div class="utf_arrow_comment"></div>
                                        <div class="utf_star_rating_section" data-rating="5"></div>
                                        <a href="#" class="rate-review">Helpful Review <i
                                                class="fa fa-thumbs-up"></i></a>
                                        <div class="utf_by_comment">Francis Burton<span class="date"><i
                                                    class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span> </div>
                                ...
                                <li>
                                    <div class="avatar"><img src="{{asset('public/web/images/happy-client-02.jpg')}}" alt="" /> </div>
                                    <div class="utf_comment_content">
                                        <div class="utf_arrow_comment"></div>
                                ...
                                <li>
                                    <div class="avatar"><img src="{{asset('public/web/images/happy-client-03.jpg')}}" alt="" /> </div>
                                    <div class="utf_comment_content">
                                        <div class="utf_arrow_comment"></div>
                                        <div class="utf_star_rating_section" data-rating="4"></div>
                                        <div class="utf_by_comment">Francis Burton<span class="date"><i
                                ...
                                <li>
                                    ...
                                    <div class="utf_comment_content">
                                        ...
                                        <div class="review-images utf_gallery_container">
                                            <a href="{{asset('public/web/images/review-image-01.jpg')}}" class="utf_gallery"><img
                                                    src="{{asset('public/web/images/review-image-01.jpg')}}" alt=""></a>
                                            <a href="{{asset('public/web/images/review-image-02.jpg')}}" class="utf_gallery"><img
                                                    src="{{asset('public/web/images/review-image-02.jpg')}}" alt=""></a>
                                            <a href="{{asset('public/web/images/review-image-03.jpg')}}" class="utf_gallery"><img
                                                    src="{{asset('public/web/images/review-image-03.jpg')}}" alt=""></a>
                                            <a href="{{asset('public/web/images/review-image-01.jpg')}}" class="utf_gallery"><img
                                                    src="{{asset('public/web/images/review-image-01.jpg')}}" alt=""></a>
                                            <a href="{{asset('public/web/images/review-image-02.jpg')}}" class="utf_gallery"><img
                                                    src="{{asset('public/web/images/review-image-02.jpg')}}" alt=""></a>
                ...
                <div class="col-lg-4 col-md-4 margin-top-75 sidebar-search">
                    ...
                    <div class="utf_box_widget booking_widget_box">
                        ...
                        <a href="listing_booking.html"
                            class="utf_progress_button button fullwidth_block margin-top-5">Request Booking</a>
                        <button class="like-button add_to_wishlist"><span class="like-icon"></span> Add to
                            Wishlist</button>
                        <div class="clearfix"></div>
                    </div>
                    <div class="utf_box_widget margin-top-35">
                        ...
                        <div class="utf_hosted_by_user_title"> <a href="#" class="utf_hosted_by_avatar_listing"><img
                                    src="{{asset('public/web/images/dashboard-avatar.jpg')}}" alt=""></a>
                        ...
                        <ul class="utf_listing_detail_sidebar">
                            ...
                            <li><i class="fa fa-envelope-o"></i> <a href="mailto:info@example.com">info@example.com</a>
                            </li>
                        </ul>
                    </div>
                    <div class="utf_box_widget margin-top-35">
                    ...
                    <div class="opening-hours margin-top-35">
                        <div class="utf_coupon_widget" style="background-image: url(public/web/images/coupon-bg-1.jpg);">
                    ...
                    <div class="utf_box_widget opening-hours margin-top-35">
                        ...
                        <span><img src="{{asset('public/web/images/google_adsense.jpg')}}" alt="" /></span>
                    </div>
                    <div class="utf_box_widget margin-top-35">
                        ...
                        <div class="col-md-12">
                            <div class="simple_slick_carousel_block utf_dots_nav">
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        ...
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-01.jpg')}}" alt="">
                                ...
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        class="utf_listing_item-container compact">
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-02.jpg')}}" alt="">
                                ...
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        class="utf_listing_item-container compact">
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-03.jpg')}}" alt="">
                                ...
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        class="utf_listing_item-container compact">
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-04.jpg')}}" alt="">
                                ...
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        class="utf_listing_item-container compact">
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-05.jpg')}}" alt="">
                                ...
                                <div class="utf_carousel_item"> <a href="listings_single_page_1.html"
                                        class="utf_listing_item-container compact">
                                        <div class="utf_listing_item"> <img src="{{asset('public/web/images/utf_listing_item-06.jpg')}}" alt="">
                                            <span class="tag"><i class="im im-icon-Chef-Hat"></i> Restaurant</span>
                                            <span class="utf_open_now">Open Now</span>
                                            <div class="utf_listing_item_content">
                                                <div class="utf_listing_prige_block">
