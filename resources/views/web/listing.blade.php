          ...
          <div class="col-lg-8 col-md-8">
              <div class="listing_filter_block">
                  <div class="col-md-2 col-xs-2">
                      <div class="utf_layout_nav"> <a href="listings_grid_with_sidebar.html" class="grid"><i
                  ...
                  <div class="col-md-10 col-xs-10">
                      ...
                      <div class="sort-by">
                          <div class="utf_sort_by_select_item utf_search_map_section">
                              <ul>
                                  <li><a class="utf_common_button" href="#"><i class="fa fa-dot-circle-o"></i>Near
                                          Me</a></li>
                              </ul>
                          </div>
                      </div>
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-01.jpg') }}" alt="">
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-02.jpg') }}" alt="">
                                  <span class="like-icon"></span>
                                  <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-03.jpg') }}" alt="">
                                  <span class="like-icon"></span>
                                  <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
                                  <div class="utf_listing_prige_block utf_half_list">
                                      <span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $25 - $45</span>
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-04.jpg') }}" alt="">
                                  <span class="like-icon"></span>
                                  <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
                                  <span class="featured_tag">Featured</span>
                                  <div class="utf_listing_prige_block utf_half_list">
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-05.jpg') }}" alt="">
                                  <span class="like-icon"></span>
                                  <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
                                  <div class="utf_listing_prige_block utf_half_list">
                                      <span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $25 - $45</span>
                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="utf_listing_item-container list-layout"> <a href="{{ url('/listing-details') }}"
                              class="utf_listing_item">
                              <div class="utf_listing_item-image">
                                  <img src="{{asset('public/web/images/utf_listing_item-06.jpg') }}" alt="">
                                  <span class="like-icon"></span>
                                  <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
                                  <div class="utf_listing_prige_block utf_half_list">
                                      <span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $25 - $45</span>
          ...
          <div class="col-lg-4 col-md-4">
              <div class="sidebar">
                  <div class="utf_box_widget margin-bottom-35">
                      ...
                      <a href="#" class="more-search-options-trigger margin-bottom-10"
                          data-open-title="More Filters Options" data-close-title="More Filters Options"></a>
